...
(function () {
    ...
    this.addItem = function (opts, cb) {
        ...
        async.waterfall([
            ...
            function (acb) {
                this.db.write(opts.channel, 'item', key, opts.data, acb);
            }.bind(this),
        ], function (err, result) {
            item.id = key;
            console.log(err);
    ...
    this.addFile = function (opts, cb) {
        ...
        async.waterfall([
            ...
            function (key, acb) {
                this.db.write(opts.channel, 'item',  ikey, {
    ...
    this.delSubscription = function (opts, cb) {
        async.waterfall([
            function (acb) {
                this.userExists(acb);
            }.bind(this),
            ...
            function (acb) {
                this.db.del(opts.channel, 'subscription', opts.id, acb);
            }.bind(this),
        ], function (err, result) {
            cb(err, result);
        });
    ...
    this.listSubscription = function (opts, cb) {
        async.waterfall([
            function (acb) {
                this.userExists(acb);
            }.bind(this),
            ...
            var limit = opts.query.limit || 50;
            var items = [];
            if(dir.children.hasOwnProperty('subscription')) {
                var subs = Object.keys(dir.children['subscription']);
            }
    ...
    this.getSubscription = function (opts, cb) {
        async.waterfall([
            function (acb) {
                this.userExists(acb);
            }.bind(this),
            ...
            function (acb) {
                this.db.read(opts.channel, 'subscription', opts.id, acb);
            }.bind(this),
        ], function (err, result) {
            cb(err, result);
        });
